    ...
    <section class="maincontainer">
      <article>
        ...
        <figure class="imgtwo first">
          <img src="img/8-oeserigi-appenzell-innerrhoden-schwende-wasserauen-eigentumswohnungen-hauptgasse.jpg" alt="8-oeserigi-appenzell-innerrhoden-schwende-wasserauen-eigentumswohnungen-hauptgasse">
          <figcaption>Hauptgasse Appenzell<br>12 min mit dem Velo</figcaption>
        </figure>
        <figure class="imgtwo second">
          <img src="img/8-oeserigi-appenzell-innerrhoden-schwende-wasserauen-eigentumswohnungen-golfplatz-gonten.jpg" alt="8-oeserigi-appenzell-innerrhoden-schwende-wasserauen-eigentumswohnungen-golfplatz-gonten">
          <figcaption>Golfplatz Gonten <br>12 min mit dem Auto</figcaption>
        </figure>
        <figure class="imgone">
          <img src="img/8-oeserigi-appenzell-innerrhoden-schwende-wasserauen-eigentumswohnungen-ebenalp-aescher.jpg" alt="8-oeserigi-appenzell-innerrhoden-schwende-wasserauen-eigentumswohnungen-ebenalp-aescher">
          <figcaption>Restaurant Äscher<br> 1h 10min zu Fuss</figcaption>
        </figure>
      </article>
      ...
      <article>
        ...
        <div class="tabeltwo">
          ...
          <p>6 min	<span>Primarschule</span></p>
          <p>6 min	<span>Haltestelle AB</span></p>
          <br>
      ...
      <article>
        ...
        <figure class="imgone">
          ...
          <figcaption>Skigebiet Ebenalp <br> 11 min mit dem Zug nach Wasserauen, Talabfahrt direkt nach Hause.</figcaption>
        </figure>
      </article>
      ...
      <article>
        ...
        <figure class="imgtwo second">
          <img src="img/8-oeserigi-appenzell-innerrhoden-schwende-wasserauen-eigentumswohnungen-kinderland-skigebiet-horn.jpg" alt="8-oeserigi-appenzell-innerrhoden-schwende-wasserauen-eigentumswohnungen-kinderland-skigebiet-horn">
          <figcaption>Skigebiet Horn Kinderland<br>2 min mit den Ski</figcaption>
        </figure>
      </article>
    </section>
