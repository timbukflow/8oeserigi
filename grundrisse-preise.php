    ...
    <section class="gcontainer">
      ...
      <article class="gbereich">
        <div class="ghaus">
          ...
          <h3>Haus A1</h3>
          <h4><a class="planb phfade"><img src="img/show-icon.svg" width="16" height="16" alt="download icon"> Übersicht</a></h4>
          ...
          <h4 class="verkaufstatus">Zum Verkauf: <br> A1-03 4.5 Zi. WHG</h4>
          ...
          <div id="a103" class="fade-in-panel">
            <table>
              ...
              <tr>
                ...
                <td><strong>925'000 CHF</strong></td>
              </tr>
            </table>
          </div>
        </div>
        ...
        <div class="ghaus">
          ...
          <h4 class="verkaufstatus"> Zum Verkauf: <br> A4-05 3.5 Zi. WHG</h4>
          <div id="a405" class="fade-in-panel">
            <table>
              <tr>
                <td> <strong>A4-05</strong></td>
              ...
              <tr>
                <td><strong>Verkaufspreis</strong></td>
                <td><strong>955'000 CHF</strong></td>
              </tr>
            </table>
          </div>
        </div>
      ...
      <!-- <article class="gbereich">
        ...
        <div class="ghaus">
          <img class="hausimg" src="img/8-oeserigi-grundriss-haus-b-3.svg" alt="8-oeserigi-grundriss-haus-b-3">
          <h3>Haus B3</h3>
          <h4><a class="planb phfade"><img src="img/show-icon.svg" width="16" height="16" alt="download icon"> Übersicht</a></h4>
